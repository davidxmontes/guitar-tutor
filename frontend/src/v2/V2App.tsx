...
export function V2App() {
  ...
  const handleComparison = async (recipe: 'scale-comparison' | 'physical-resolution' | 'four-chord-progression' = 'scale-comparison') => {
    try {
