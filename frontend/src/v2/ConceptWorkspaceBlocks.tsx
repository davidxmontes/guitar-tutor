...
export function ConceptWorkspaceBlock({ block, workspace, resolved, inspection, onInspect, tutorFocus, readOnly = false, disabled = false, onProgressionAction, onWorkspaceChange, onHear }: {
