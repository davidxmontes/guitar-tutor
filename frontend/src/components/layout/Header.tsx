        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div ref={settingsRef} className="relative">
            <button
              ...
              style={{
                backgroundColor: settingsOpen ? 'var(--bg-secondary)' : 'var(--bg-tertiary)',
            ...
            {settingsOpen && (
              <div
                className="absolute right-0 top-full mt-2 w-48 rounded-xl border shadow-lg z-50 p-3 flex flex-col gap-3"
                style={{
              ...
              >
                <div className="flex flex-col gap-1.5">
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border px-2 py-1.5 text-sm font-medium cursor-pointer"
                    style={{
